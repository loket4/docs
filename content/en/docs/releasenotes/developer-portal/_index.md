...
* It's here: Feedback 2.0. Together with Mini Surveys, the new [feedback management tool](/developerportal/app-insights/feedback) forms our brand new suite called App Insights. App Insights is officially generally available as of today and it enables you to collect, analyze and act on the input of your users and innovate faster. So what's new when it comes to feedback management?
...
* Complementing Feedback Management, Mendix [Mini Surveys](/developerportal/app-insights/mini-surveys) will help to set short effective surveys to gather diverse feedback and empowers data-driven decision-making to improve app and features. What are the key benefits of our customisable Mini Survey?
